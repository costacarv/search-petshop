...
const home = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObbject_1.createMenuObject)('all'),
        banner: {
...
const dogs = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObbject_1.createMenuObject)('dog'),
        banner: {
            title: 'Cachorros',
...
const cats = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObbject_1.createMenuObject)('cat'),
        banner: {
            title: 'Gatos',
...
const fishes = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObbject_1.createMenuObject)('fish'),
        banner: {
            title: 'Peixes',
